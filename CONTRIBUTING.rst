...
Welcome to ``spacepylot`` contributor's guide.
...
If you experience bugs or general issues with ``spacepylot``, please have a look
...
You can help improve ``spacepylot`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``spacepylot`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``spacepylot``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n spacepylot python=3 six virtualenv pytest pytest-cov
    conda activate spacepylot
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/spacepylot.git
    cd spacepylot
...
#. Install |pre-commit|_::
   ...
   ``spacepylot`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/spacepylot
.. _issue tracker: https://github.com/<USERNAME>/spacepylot/issues
.. <-- end -->
